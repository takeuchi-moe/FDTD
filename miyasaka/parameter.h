...
static const int Nmax = 50000; //150000 				// ?ｿｽ?ｿｽ?ｿｽﾅ終?ｿｽ?ｿｽ?ｿｽﾔス?ｿｽe?ｿｽb?ｿｽv
...
static const int Ncut = 1000; //50000				// ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽﾔス?ｿｽe?ｿｽb?ｿｽv?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ\?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽﾔ隔
...
static const int Fcut = 1000; 				//200 ?ｿｽt?ｿｽB?ｿｽ[?ｿｽ?ｿｽ?ｿｽh?ｿｽ?ｿｽ?ｿｽo?ｿｽﾍゑｿｽ?ｿｽ骼橸ｿｽﾔス?ｿｽe?ｿｽb?ｿｽv?ｿｽ?ｿｽ (?ｿｽﾅ終?ｿｽv?ｿｽZ?ｿｽX?ｿｽe?ｿｽb?ｿｽv?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽﾌ搾ｿｽ)
...
static const int Ncheck = 1000; //10					// ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽm?ｿｽF?ｿｽp?ｿｽﾌフ?ｿｽB?ｿｽ[?ｿｽ?ｿｽ?ｿｽh?ｿｽ?ｿｽ?ｿｽo?ｿｽﾍゑｿｽ?ｿｽ骼橸ｿｽﾔス?ｿｽe?ｿｽb?ｿｽv
...
static const int Ncutfield2 = 1000; 			// ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽ?ｿｽﾔでのフ?ｿｽB?ｿｽ[?ｿｽ?ｿｽ?ｿｽh?ｿｽ?ｿｽ?ｿｽo?ｿｽﾍゑｿｽ?ｿｽ骼橸ｿｽﾔス?ｿｽe?ｿｽb?ｿｽv?ｿｽﾔ隔
...
char *dir_name[] = {"1560"}; 		// ?ｿｽ?ｿｽ?ｿｽU?ｿｽﾖ撰ｿｽ?ｿｽﾌ波?ｿｽ?ｿｽ [nm]
#else
//char *dir_name[] = {"1530", "1535"}; 		// ?ｿｽ?ｿｽ?ｿｽU?ｿｽﾖ撰ｿｽ?ｿｽﾌ波?ｿｽ?ｿｽ [nm]
//char *dir_name[] = {"1545", "1550"}; 		// ?ｿｽ?ｿｽ?ｿｽU?ｿｽﾖ撰ｿｽ?ｿｽﾌ波?ｿｽ?ｿｽ [nm]
char *dir_name[] = {"1570"}; 		// ?ｿｽ?ｿｽ?ｿｽU?ｿｽﾖ撰ｿｽ?ｿｽﾌ波?ｿｽ?ｿｽ [nm]?ｿｽ?ｿｽ?ｿｽv?ｿｽZ?ｿｽ?ｿｽ
#endif
#endif
#else
...
#endif
#else
char *dir_name[] = {"1560"}; 		// ?ｿｽ?ｿｽ?ｿｽU?ｿｽﾖ撰ｿｽ?ｿｽﾌ波?ｿｽ?ｿｽ [nm]?ｿｽ?ｿｽ?ｿｽf?ｿｽ?ｿｽ?ｿｽo?ｿｽ?ｿｽ?ｿｽ?ｿｽ
#endif
